            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mt-1">
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-bordered" id="tableRecentPresensi" role="grid"
                                    ...
                                    <tbody>
                                        @foreach ($dataPresensis as $presensi)
                                            <tr role="row" class="odd">
                                                <td>{{ date("d/m/Y",strtotime($presensi->tgl_mulai ))}} - {{ date("d/m/Y",strtotime($presensi->tgl_selesai ))}}</td>
